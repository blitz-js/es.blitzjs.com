...
de usar. Para lanzar las pruebas en tu aplicación, tendrás que ejecutar `jest` o `jest --watch` desde el terminal.
...
> [lee la documentación de Jest](https://jestjs.io/docs/en/using-matchers)
