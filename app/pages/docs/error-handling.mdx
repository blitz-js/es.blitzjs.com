...
Blitz viene con una cantidad de errores útiles que puedes usar en toda tu
aplicación.
...
Para manejar los errores en el cliente, usas un [`<ErrorBoundary>`](./error-boundary).
...
Errores personalizadas. Así puedes agegar propiedades de datos personalizadas
